...
const BeerCard = ({ beerName, breweryName, imageUrl, gradientColors, imageHeight, WidthCard }) => {
  const gradientClass = classNames(
    'bg-gradient-to-b', // Gradient de haut en bas
    {
      ...
      'from-coral to-darkorange': gradientColors[0] === '#FF7F50' && gradientColors[1] === '#FF4500',
      'from-skyblue to-steelblue': gradientColors[0] === '#87CEEB' && gradientColors[1] === '#4682B4',
      'from-blueviolet to-indigo': gradientColors[0] === '#8A2BE2' && gradientColors[1] === '#4B0082',
    }
  );
